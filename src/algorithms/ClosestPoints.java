    ...
    public void deltaHalf() {
        ...
        for (int i = 0; i < itsByX1.size(); i++) {
            for (int j = i; j < itsByX1.size() - 1; j++) {
                theDistance = Math.pow(itsByX1.get(j + 1).getX() - itsByX1.get(i).getX(), 2)
                        + Math.pow(itsByX1.get(j + 1).getY() - itsByX1.get(i).getY(), 2);
        ...
        for (int i = 0; i < itsByX2.size(); i++) {
            for (int j = i; j < itsByX2.size() - 1; j++) {
                theDistance = Math.pow(itsByX2.get(j + 1).getX() - itsByX2.get(i).getX(), 2)
                        + Math.pow(itsByX2.get(j + 1).getY() - itsByX2.get(i).getY(), 2);
