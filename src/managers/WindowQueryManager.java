...
public class WindowQueryManager {
    ...
    public WindowQueryManager() {
        ...
        itsQueryBox.add(new Line(theLeft.getEndX(), theLeft.getEndY(), theRight.getStartX(), theRight.getStartY()));
        itsQueryBox.add(new Line(theLeft.getStartX(), theLeft.getStartY(), theRight.getEndX(), theRight.getEndY()));

        System.out.println("left : " + theLeft.getStartX() + "," + theLeft.getStartY() + "   " + theLeft.getEndX()
                + "," + theLeft.getEndY());
        System.out.println("right : " + theRight.getStartX() + "," + theRight.getStartY() + "   " + theRight.getEndX()
                + "," + theRight.getEndY());
